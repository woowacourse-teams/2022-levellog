...
class InterviewQuestionTest {
    ...
    class Constructor {
        ...
        void constructor_interviewQuestionContentLength_exception() {
            ...
            // when & then
            assertThatThrownBy(() -> new InterviewQuestion(authorId, levellog, content))
    ...
    class UpdateContent {
        ...
        void updateContent_contentLength_exception() {
            ...
            final InterviewQuestion interviewQuestion = new InterviewQuestion(memberId, levellog, "스프링이란?");

            // when & then
            final String updatedContent = "a".repeat(256);
            assertThatThrownBy(() -> interviewQuestion.updateContent(updatedContent, memberId))
                    .isInstanceOf(InvalidFieldException.class)
        ...
        void updateContent_unauthorized_exception() {
            ...
            final Long otherMemberId = otherMember.getId();
            ...
            // when & then
            assertThatThrownBy(() -> interviewQuestion.updateContent("스프링 빈이란?", otherMemberId))
                    .isInstanceOf(MemberNotAuthorException.class)
                    .hasMessageContainingAll("작성자가 아닙니다.", String.valueOf(otherMemberId),
