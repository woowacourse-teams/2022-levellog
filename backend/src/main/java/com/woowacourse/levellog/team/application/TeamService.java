...
public class TeamService {
    ...
    @Transactional
    public Long save(final TeamWriteDto request, @FromToken final LoginStatus loginStatus) {
    ...
    @Transactional
    public void update(final TeamWriteDto request, final Long teamId, @FromToken final LoginStatus loginStatus) {
        final Team team = teamRepository.getTeam(teamId);
    ...
    @Transactional
    public void close(final Long teamId, @FromToken final LoginStatus loginStatus) {
        final Team team = teamRepository.getTeam(teamId);
        validateHostAuthorization(loginStatus.getMemberId(), team);
    ...
    @Transactional
    public void deleteById(final Long teamId, @FromToken final LoginStatus loginStatus) {
        final Team team = teamRepository.getTeam(teamId);
        validateHostAuthorization(loginStatus.getMemberId(), team);
