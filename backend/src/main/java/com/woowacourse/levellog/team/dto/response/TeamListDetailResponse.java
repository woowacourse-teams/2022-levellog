...
public class TeamListDetailResponse {
    ...
    public static TeamListDetailResponse of(final List<TeamListDetailQueryResult> simpleParticipants,
                                            final TeamStatus status) {
        final TeamListDetailQueryResult result = simpleParticipants.get(0);
