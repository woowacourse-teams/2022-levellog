...
public class MyInfoController {
    ...
    @GetMapping
    public ResponseEntity<MemberDto> myInfo(@Authentic final LoginStatus loginStatus) {
    ...
    public ResponseEntity<FeedbacksDto> findAllFeedbackToMe(@Authentic final LoginStatus loginStatus) {
    ...
    public ResponseEntity<LevellogsDto> findAllMyLevellogs(@Authentic final LoginStatus loginStatus) {
    ...
    @GetMapping("/teams")
    public ResponseEntity<TeamListDto> findAllMyTeams(@Authentic final LoginStatus loginStatus) {
    ...
    @PutMapping
    public ResponseEntity<Void> updateNickname(@Authentic final LoginStatus loginStatus,
